...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["accounts_user.id"], name="fk_sipstore_sip_user_id"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["pid_id"], ["pidstore_pid.id"], name="fk_sipstore_recordsip_pid_id"
        ),
        sa.ForeignKeyConstraint(
            ["sip_id"], ["sipstore_sip.id"], name="fk_sipstore_recordsip_sip_id"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sip_id"], ["sipstore_sip.id"], name="fk_sipstore_sipfile_sip_id"
        ),
